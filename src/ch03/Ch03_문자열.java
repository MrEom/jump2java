...
public class Ch03_문자열 {
    public static void main(String[] args) {
        ...
        c = "hello";
        // 문자열 비교 메서드 equals
        System.out.println(a.equals(b)); // a와 b가 같으면 참
        System.out.println(a.equals(c)); // a와 c가 같으면 참
        ...
        a = "Hello Java";
        System.out.println(a.contains("Java"));//참
        ...
        System.out.println(String.format("나는 사과를 %s개를 먹었다!", "다섯"));
